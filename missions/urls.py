...
urlpatterns = [
    ...
    path('update-details/<int:update_id>/edit-update/', views.edit_update, name='edit_update'),
    path('delete-update/<int:update_id>/', views.delete_update, name='delete_update'),
]
